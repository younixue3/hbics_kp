				...
				<div class="card-body card-block">
					...
					<form action="{{ url('timelines/'.$event->id) }}" method="POST" enctype="multipart/form-data">
						...
						<div class="form-group">
							<label>Nama</label>
							<input type="text" required placeholder="Masukkan Nama Timeline" class="form-control" name="nama">
						</div>
						<div class="form-group">
							<label>Keterangan</label>
							<input type="text" required placeholder="Masukkan Keterangan Timeline" class="form-control" name="keterangan">
						</div>
						<div class="form-group">
