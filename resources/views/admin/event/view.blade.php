                ...
                <div class="card-body card-block">
                    ...
                    <table class="table tabledetail">
                        ...
                        <tr>
                            <th>Timeline</th>
                            <td>
                                <a href="{{url('timelines/'.$data->id)}}"><i
                                        class="icofont-rounded-right"></i> {{$data->timelines->count()}} Timeline</a>
                            </td>
                        </tr>
                        <tr>
                            <th>Juri</th>
                            <td>
                                <a href="{{url('juris/'.$data->id)}}"><i
                                        class="icofont-rounded-right"></i> {{$data->juris->count()}} Juri</a>
                            </td>
                        </tr>
                        <tr>
                            <th>Karya/ Peserta</th>
                            <td>
                                <a href="{{url('pesertas/'.$data->id)}}"><i
                                        class="icofont-rounded-right"></i> {{$peserta}} Peserta</a>
                            </td>
                        </tr>
                        <tr>
                            <th>Sponsor</th>
                            <td>
                                <a href="{{url('sponsors/'.$data->id)}}"><i
                                        class="icofont-rounded-right"></i> {{$data->sponsors->count()}} Sponsor</a>
                            </td>
                        </tr>
                    </table>
                </div>
