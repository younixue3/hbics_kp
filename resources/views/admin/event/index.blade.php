                        ...
                        @foreach($datas as $data)
                            <tr>
                                ...
                                <td><img style="width:50px;" class="img-responsive"
                                         src="{{asset('uploads/events/'.$data->logo)}}" alt=""></td>
                                <td>{{ $data->tagline }}</td>
                                <td>
                                ...
                                <td>
                                    <a class="btn btn-sm btn-success"
                                       href="{{ url('events/'.$data->id.'/'.str_Replace(' ', '-', $data->tagline)) }}"><i
                                                class="fas fa-eye"></i></a>
                                    <a class="btn btn-sm btn-info" href="{{ url('events/'.$data->id.'/edit') }}"><i
                                                class="fas fa-edit"></i></a>
                                    <a class="btn btn-sm btn-danger" href="{{ url('events/'.$data->id.'/delete') }}"><i
