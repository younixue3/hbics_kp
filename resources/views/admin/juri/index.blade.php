					...
					<table class="table table-striped">
						...
						@foreach($event->juris as $data)									
							<tr>
								...
								<td>{{$data->quote}}</td>
								<td>
									<a class="btn btn-sm btn-success" href="{{ url('juris/'.$event->id.'/'.str_Replace(' ', '-', $data->tagline)) }}"><i class="fas fa-eye"></i></a>
									<a class="btn btn-sm btn-info" href="{{ url('juris/'.$event->id.'/'.$data->id.'/edit') }}"><i class="fas fa-edit"></i></a>
									<a class="btn btn-sm btn-danger" href="{{ url('juris/'.$event->id.'/delete') }}"><i class="fas fa-trash"></i></a>									
								</td>
							</tr>
						@endforeach
						</tbody>
