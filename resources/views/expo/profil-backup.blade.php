                    ...
                    <div class="apaitu apaitu--profil">
                        ...
                        <div class="apaitu-mid">
                              ...
                              <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                  ...
                                  <div class="modal-body">
                                    <form id="form-participant-names" action="{{url('creation')}}" method="POST">
                                        @csrf
                                        @method('PUT')
                                        <input type="hidden" name="creation_id" value="{{$creation->id}}">
                                    </form>
                                    <textarea form="form-participant-names" name="participant_names" rows="10" placeholder="Masukkan nama tim"></textarea>
                                  </div>
                                  <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                    <button form="form-participant-names" type="submit" class="btn btn-primary">Simpan Perubahan</button>
                                  </div>
                                </div>
                              </div>
                          </div>  
                          ...
                          <p class="namateam wow fadeInUp" data-wow-delay="2s">
                            ...
                            @endphp
                            <i class="icofont-check wow fadeInUp" data-wow-delay="2s"></i> Jenjang : {{$jenjang ?? 'Belum diatur'}}, Kategori: {{$kategori ?? 'Belum diatur'}}
                          </p>   
                          ...
                          <div class="modal fade" id="jenjang" tabindex="-1" role="dialog" aria-labelledby="jenjangLabel" aria-hidden="true">
                              <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                  ...
                                  <div class="modal-body">
                                    <form id="form-level-category" action="{{url('creation')}}" method="POST">
                                      @csrf
                                      @method('PUT')
                                      <input type="hidden" name="creation_id" value="{{$creation->id}}">
                                    </form>
                                    <label for="">Jenjang</label>
                                    <select form="form-level-category" name="level" class="form-control" style="color: black !important">
                                  ...
                                  <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                    <button form="form-level-category" type="submit" class="btn btn-primary">Simpan Perubahan</button>
                                  </div>
                                </div>
                              </div>
                          </div>     
                              ...
                              <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                  ...
                                  <div class="modal-body">
                                    ...
                                    <textarea form="form-about-team" name="about_team" rows="10" placeholder="Masukkan deskripsi 'tentang kami'"></textarea>
                                  </div>
                                  <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                    <button form="form-about-team" type="submit" class="btn btn-primary">Simpan Perubahan</button>
                                  </div>
                                </div>
                              </div>
                          </div>
                        ...
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            ...
                            <div class="modal-body text-left">
                              <form id="form-image-team" action="{{url('creation')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <input type="hidden" name="creation_id" value="{{$creation->id}}">
                              </form>
                            ...
                            <div class="modal-footer">
                              <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                              <button form="form-image-team" type="submit" class="btn btn-primary">Simpan Perubahan</button>
                            </div>
                          </div>
                        </div>
                    </div>
  ...
  <div class="row frame">
    ...
    <div class="col-md-6 wow fadeInUp" data-wow-delay="0.5s" style="background-color: #FFDE5A">
        <div class="deskripsi text-center">
            ...
            <p class="deskripsi-title wow fadeInUp" data-wow-delay="1.5s" style="font-size: 20px">"{{$creation->product_name ?? 'Nama produk belum diatur'}}"</p>
                ...
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-body text-left">
                      ...
                      <input form="form-product" name="product_name" type="text" class="form-control" placeholder="Masukkan nama produk">
                      <label for="">Deskripsi Produk</label>
                      <textarea form="form-product" name="product_description" rows="10" placeholder="Masukkan deskripsi 'produk'"></textarea>
                    </div>
                    <div class="modal-footer">
                      <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
...
<div class="container-fluid">
  <div class="row frame frame2">
    <div class="container">
      <div class="row">
        <div class="col-md-2">
          <a href="#" data-toggle="modal" data-target="#fotoMass" class="button-text wow fadeInUp" data-wow-delay="1s">Tambah foto produk<i class="icofont-image"></i></a>
        ...
        <div class="col-md-10 wow fadeInUp" data-wow-delay="1s">
          <div class="row">
            @forelse ($creation->product_images() as $imageId)
              <div class="col-md-4">
                <img src="{{url('image/'.$imageId)}}" class="slide-image" style="height: 200px; object-fit:cover;margin-bottom:15px;" alt="">
                            ...
                            <div class="modal fade" id="video" tabindex="-1" role="dialog" aria-labelledby="videoLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                  <div class="modal-content">
                                    ...
                                    <div class="modal-body text-left">
                                      <form id="form-link-profile" action="{{url('creation')}}" method="POST">
                                        @csrf
                                        @method('PUT')
                                        <input type="hidden" name="creation_id" value="{{$creation->id}}">
                                      </form>
                                      <label for="">Link video profil</label>
                                      <input form="form-link-profile" name="link_profile" type="text" class="form-control" placeholder="Masukkan link youtube">
                                    </div>
                                    <div class="modal-footer">
                                      <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                      <button form="form-link-profile" type="submit" class="btn btn-primary">Simpan Perubahan</button>
                                    </div>
                                  </div>
                                </div>
                            </div>
                            ...
                            <div class="modal fade" id="presentasi" tabindex="-1" role="dialog" aria-labelledby="presentasiLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                  <div class="modal-content">
                                    ...
                                    <div class="modal-body text-left">
                                      <form id="form-link-presentation" action="{{url('creation')}}" method="POST">
                                        @csrf
                                        @method('PUT')
                                        <input type="hidden" name="creation_id" value="{{$creation->id}}">
                                      </form>
                                      <label for="">Link video presentasi</label>
                                      <input form="form-link-presentation" name="link_presentation" type="text" class="form-control" placeholder="Masukkan link youtube">
                                    </div>
                                    <div class="modal-footer">
                                      <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                      <button form="form-link-presentation" type="submit" class="btn btn-primary">Simpan Perubahan</button>
                                    </div>
                                  </div>
                                </div>
                            </div>
                            ...
                            <div class="modal fade" id="mockup" tabindex="-1" role="dialog" aria-labelledby="mockupLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                  <div class="modal-content">
                                    ...
                                    <div class="modal-body text-left">
                                      <form id="form-link-mockup" action="{{url('creation')}}" method="POST">
                                        @csrf
                                        @method('PUT')
                                        <input type="hidden" name="creation_id" value="{{$creation->id}}">
                                      </form>
                                      <label for="">Link video mockup</label>
                                      <input form="form-link-mockup" name="link_mockup" type="text" class="form-control" placeholder="Masukkan link youtube">
                                    </div>
                                    <div class="modal-footer">
                                      <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                      <button form="form-link-mockup" type="submit" class="btn btn-primary">Simpan Perubahan</button>
                                    </div>
                                  </div>
                                </div>
                            </div>
                            ...
                            <div class="modal fade" id="dokumen" tabindex="-1" role="dialog" aria-labelledby="dokumenLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                  <div class="modal-content">
                                    ...
                                    <div class="modal-body text-left">
                                      <form id="form-document-proposal" action="{{url('creation')}}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        <input type="hidden" name="creation_id" value="{{$creation->id}}">
                                      </form>
                                      <label for="">Dokumen proposal</label>
                                      <input form="form-document-proposal" name="proposal" type="file" accept="application/pdf">
                                    </div>
                                    <div class="modal-footer">
                                      <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                      <button form="form-document-proposal" type="submit" class="btn btn-primary">Simpan Perubahan</button>
                                    </div>
                                  </div>
                                </div>
                            </div>
                            ...
                            <div class="modal fade" id="poster" tabindex="-1" role="dialog" aria-labelledby="posterLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                  <div class="modal-content">
                                    ...
                                    <div class="modal-body text-left">
                                      <form id="form-image-poster" action="{{url('creation')}}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        <input type="hidden" name="creation_id" value="{{$creation->id}}">
                                      </form>
                                    ...
                                    <div class="modal-footer">
                                      <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                      <button form="form-image-poster" type="submit" class="btn btn-primary">Simpan Perubahan</button>
                                    </div>
                                  </div>
                                </div>
                            </div>
            ...
            <div class="row">
                <div class="col-md-8">
                  <div class="total wow fadeInUp" data-wow-delay="1s">
                      <p><i class="icofont-like"></i> total likes : {{count($creation->product_likers())}}, <i class="icofont-comment"></i> total komentar : {{$creation->comments->count()}}</p>
                  </div>
                  ...
                  <div class="komen wow fadeInUp" data-wow-delay="1.5s">
                    ...
                    <div class="komen-content">
                        <p class="komen-text">
                            Lorem ipsum dolor sit amet consectetur adipisicing elitumque quos nisi quas tempore esse veniam.
                        </p>
                        <p class="komen-info">
