...
{{--                                    {{dd($karya->karya->likes)}}--}}
                                    <div class="list wow fadeInUp" data-wow-delay="0.5s">
                                        <div class="list-imageframe">
                                            <img src="{{url('Upload/karyafotos/'.$karya->karya->foto->first()->foto)}}" alt="" class="list-image">
                                        </div>
                                        <div class="list-content">
                                            <a style="margin-bottom: 0px;" href="{{url('expo/'.$jenjang.'/'.$kategori.'/'.$karya->karya->id.'/'.str_replace(' ', '-', $karya->karya->nama))}}" class="list-title">{{$karya->karya->nama}}</a>
