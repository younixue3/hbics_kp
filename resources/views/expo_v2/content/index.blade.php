        ...
        <div>
            <div class="h-64 w-96 flex">
                ...
                <div class="absolute flex w-96">
                    ...
                    <div class="bg-white transform skew-y-6 absolute bottom-2 right-3 h-32 w-16 flex flex-col gap-y-2 p-1">
                        <img class="bg-gray-700 h-20 w-full object-contain" src="{{asset('images/logo-white.png')}}">
                        <img class="bg-gray-700 h-20 w-full object-contain" src="{{asset('images/logo-white.png')}}">
                    </div>
                    <div class="bg-white transform -skew-y-6 absolute bottom-2 left-3 h-32 w-16 flex flex-col gap-y-2 p-1">
                        <img class="bg-gray-700 h-20 w-full object-contain" src="{{asset('images/logo-white.png')}}">
                        <img class="bg-gray-700 h-20 w-full object-contain" src="{{asset('images/logo-white.png')}}">
                    </div>
                </div>
