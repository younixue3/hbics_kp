...
class   User extends Authenticatable
{
     ...
     */
    protected $fillable = [
        'name', 'email', 'password', 'desc', 'role', 'provinsi_id', 'kota_kab_id', 'event_id', 'kategori_peserta', 'pembayaran', 'bukti_pembayaran', 'foto_profile', 'jenjang', 'kategori_lp', 'no_hp', 'bukti_akte'
    ];
    ...
    {
        return $this->hasOne('App\Karya', 'user_id', 'id')->latest();
    }
